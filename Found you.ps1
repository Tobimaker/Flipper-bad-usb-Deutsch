...
$s.Rate = -2
$s.Speak("Wir haben dich gefunden $FN")
$s.Speak("Wir wissen wo du bist")
$s.Speak("Wir sind überall")
$s.Speak("Wir vergeben nicht, wir vergessen nicht")
$s.Speak("Wir sind Annonymous")
